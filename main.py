# main.py - FORCE RAILWAY TO USE THIS FILE - UNIQUE ID: RAILWAY_FIX_001
print("DEBUG: Using main.py from project root - sales_order import - UNIQUE ID: RAILWAY_FIX_001")
